...
class Engine::ControlSystem < RethinkORM::Base
  ...
  attribute capacity : Integer, default: 0
  attribute features : String
  attribute bookable : Boolean, default: false
  ...
  attribute installed_ui_devices : Int32, default: 0

  attribute zones : Array(Zone), default: [] of Zone
  attribute modules : Array(Module), default: [] of Module
  ...
  attribute version : Int32, default: 0
